...
@EnableJpaRepositories(
    basePackages = "com.tienda.repository.facturacion",
    entityManagerFactoryRef = "facturacionEntityManager",
...
public class FacturacionDbConfig {
    ...
    @Bean(name = "facturacionEntityManager")
    public LocalContainerEntityManagerFactoryBean facturacionEntityManager() {
        ...
        em.setPackagesToScan(".com.example.Taller_Tienda.model.facturacion");
