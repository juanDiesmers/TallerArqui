...
@EnableJpaRepositories(
        basePackages = "com.example.Taller_Tienda.Repository.pagos",
        entityManagerFactoryRef = "pagoEntityManagerFactory",
...
public class PagosDbConfig {
    ...
    @Bean(name = "pagoEntityManagerFactory")
...
//        properties.put(AvailableSettings.JAKARTA_JDBC_URL, "jdbc:mysql://mysql:3306/pagos?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true");
...
//        properties.put(AvailableSettings.JAKARTA_JDBC_PASSWORD, "MiClaveSegura123!");
        properties.put("hibernate.connection.url", "jdbc:mysql://mysql:3306/pagos?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true");
  ...
  /*  @Bean(name = "pagosTransactionManager")
    public PlatformTransactionManager pagosTransactionManager(
            @Qualifier("pagoEntityManagerFactory") EntityManagerFactory entityManagerFactory) {
